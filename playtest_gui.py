...
class PlaytestGUI:
    ...
    def _build_layout(self):
        ...
        slider_defs = [
            ...
            ("Formant gain",    "formant_gain",   0.1,   4.0,   1.0,  11),
            ("",                None,             0,     1,     0,   12),
            ("Wah Q",           "wah_Q",          0.5,  20.0,   4.0, 13),
            ("",                None,             0,     1,     0,   14),
            ("F1 BW (Hz)",      "f1_bw",         10.0, 300.0,  60.0, 15),
            ("F2 BW (Hz)",      "f2_bw",         10.0, 300.0,  90.0, 16),
            ("F3 BW (Hz)",      "f3_bw",         20.0, 400.0, 150.0, 17),
            ("F4 BW (Hz)",      "f4_bw",         20.0, 400.0, 200.0, 18),
            ("F5 BW (Hz)",      "f5_bw",         20.0, 500.0, 250.0, 19),
            ("",                None,             0,     1,     0,   20),
            ("Env depth (Hz)",  "env_f2_depth_hz", 0,  500,  150.0, 21),
            ("Env attack (ms)", "env_attack_ms",  1.0, 100.0,   5.0, 22),
            ("Env release (ms)","env_release_ms", 5.0, 500.0,  80.0, 23),
            ("",                None,             0,     1,     0,   24),
            ("Model blend",     "model_blend",    0.0,   1.0,   1.0, 25),
        ]
